 ...
 * Lllll
 *
 * This is a data helper class for SMS Subscriptions (SmsSubsDataHelper).
 * It prepares and transfers data between the HTTP request and the UserSms entity
 * (and related objects) for the SMS Subscriptions screens.
 *
 * @author Aaaaa
